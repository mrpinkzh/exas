...
namespace ExAs.Api.Timespans
{
    ...
    public class TimespanAssertion_IsPositive_Feature
    {
        ...
        {
            // act
            var result = WorkDayNinja().Evaluate(n => n.Property(x => x.awake).IsPositive());
        ...
        {
            // act
            var result = AsleepNinja().Evaluate(n => n.Property(x => x.awake).IsPositive());
        ...
        {
            // act
            var result = WokeUpNinja().Evaluate(n => n.Property(x => x.awake).IsPositive());
